...
function sendOtpByEmail(passedOtp){
  return new Promise((resolve, reject)=>{
    var transporter = nodemailer.createTransport({
      service:'gmail',
      auth:{
        user:'shajujohin@gmail.com',
        pass:'amywraflewljobxp'
      }
    })
    const mail_configs ={
      from:'shajujohin@gmail.com',
      to:'gadgetZone2k23@gmail.com',
      subject:'OTP',
...
const typeDefs = `
  ...
  type Mutation {
      ...
      productUpdate(_id:String,ProductName:String,Price:String,Category:String,Description:String): product
...
async function productUpdate(_,{ _id, ProductName, Price, Category,Description}) {
  try {
